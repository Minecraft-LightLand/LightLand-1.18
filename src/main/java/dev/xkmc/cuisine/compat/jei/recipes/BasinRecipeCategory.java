...
public class BasinRecipeCategory implements IRecipeCategory<BasinRecipe> {
	...
	private static final FluidStackRenderer RENDERER = new FluidStackRenderer(BasinBlockEntity.MAX_FLUID,
			true, 16, 16, null);
	...
	public BasinRecipeCategory() {
		this.id = new ResourceLocation(Cuisine.MODID, "basin");
	}
	...
	public Component getTitle() {
		return new TranslatableComponent(CuisineBlocks.BASIN.get().getDescriptionId());
	}
	...
	@Override
	public void setRecipe(IRecipeLayout layout, BasinRecipe sl, IIngredients list) {
		int index = 0;
