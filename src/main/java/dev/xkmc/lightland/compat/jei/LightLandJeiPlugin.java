package dev.xkmc.lightland.compat.jei;

import dev.xkmc.l2library.util.Proxy;
import dev.xkmc.lightland.compat.jei.ingredients.ElemIngredientHelper;
import dev.xkmc.lightland.compat.jei.ingredients.ElemIngredientRenderer;
import dev.xkmc.lightland.compat.jei.ingredients.ElementIngredient;
import dev.xkmc.lightland.compat.jei.recipes.DisEnchanterRecipeCategory;
import dev.xkmc.lightland.compat.jei.recipes.MagicCraftRecipeCategory;
import dev.xkmc.lightland.compat.jei.screen.ExtraInfoScreen;
import dev.xkmc.lightland.content.magic.gui.craft.ArcaneInjectScreen;
import dev.xkmc.lightland.content.magic.gui.craft.DisEnchanterScreen;
import dev.xkmc.lightland.content.magic.gui.craft.SpellCraftScreen;
