...
import dev.xkmc.lightland.content.magic.block.RitualRenderer;
import dev.xkmc.lightland.content.magic.block.RitualSide;
import dev.xkmc.lightland.content.questline.block.*;
...
public class LightlandBlocks {
	...
	static {
		...
		}
		{
			...
			LEAD_BLOCK = LightLand.REGISTRATE.block("lead_block",
		...
		}
		{
			...
			SLIME_CARPET = LightLand.REGISTRATE.block("slime_carpet", p -> new SlimeCarpet(prop_slime))
